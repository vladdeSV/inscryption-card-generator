...
const presets: { [s: string]: Card } = {
  ...
  "long_elk": { type: 'rare', name: 'long_elk', power: 1, health: 2, tribes: ['hooved'], sigils: ['deathtouch', 'strafe'], cost: { amount: 4, type: 'bone' } },
  "magpie": { type: "common", name: "magpie", power: 1, health: 1, tribes: ["bird"], sigils: ["tutor", "flying"], cost: { amount: 2, type: "blood" }, portrait: "magpie" },
  ...
  "pack_mule": { type: "common", name: "pack mule", power: 0, health: 5, sigils: ['strafe'], tribes: ['hooved'], portrait: "mule" },
  ...
  "snowy_fir": { type: "terrain", name: "snow fir", portrait: "tree_snowcovered", health: 4, sigils: ["reach"], options: { isTerrain: true } },
  ...
  "turkey_vulture": { type: "common", name: "turkey vulture", power: 3, health: 3, cost: { amount: 8, type: "bone" }, tribes: ['bird'], sigils: ['flying'], portrait: "vulture" },
  ...
  "worker_ant": { type: 'common', name: 'worker ant', power: 'ants', health: 2, cost: { amount: 1, type: 'blood' }, portrait: 'ant', tribes: ['insect'] },

  "tail_feathers": { type: 'common', name: 'tail feathers', power: 0, health: 2, portrait: 'bird_tail' },
  "furry_tail": { type: 'common', name: 'furry_tail', power: 0, health: 2, portrait: 'canine_tail' },
  "wriggling_leg": { type: 'common', name: 'wriggling leg', power: 0, health: 2, portrait: 'insect_tail' },
  "wriggling_tail": { type: 'common', name: 'wriggling_tail', power: 0, health: 2, portrait: 'skink_tail' },

  "hungry_child": { type: 'common', decals: ['child'] },
