...
function resourceIdFromCreatureId(creatureId: CreatureId): string {
  switch (creatureId) {
    ...
    // Kaycee's Mod
    case '!GIANTCARD_SHIP': return '!giantcard_ship'
    case 'AntFlying': return 'antflying'
    case 'AquaSquirrel': return 'aquasquirrel'
    case 'BrokenEgg': return 'brokenegg'
    case 'Bull': return 'bull'
    case 'Cuckoo': return 'cuckoo'
    case 'DireWolf': return 'direwolf'
    case 'DireWolfCub': return 'direwolfcub'
    case 'Hodag': return 'hodag'
    case 'Hydra': return 'hydra'
    case 'HydraEgg': return 'hydraegg'
    case 'Ijiraq': return 'ijiraq'
    case 'Kraken': return 'kraken'
    case 'Lammergeier': return 'lammergeier'
